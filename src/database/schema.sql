...
CREATE TABLE users (
    ...
    login_id_hash VARCHAR (255) UNIQUE NOT NULL
);
CREATE TABLE brands (
...
CREATE TABLE tool_types (
    tooltype_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE tool_subtypes (
    subtype_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    tooltype_id INT NOT NULL REFERENCES tool_types (tooltype_id) NOT NULL,
    subtype_name VARCHAR (255) UNIQUE NOT NULL
);
CREATE TABLE tools (
    tool_code INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE scan_log (
    scan_log_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
